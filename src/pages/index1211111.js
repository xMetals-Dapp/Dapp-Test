...
import xGLD_Kilo from "components/xGLD_kilo";
...
try{
	...
	let mintAmount = realAmount * 32.1507;
	...
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"index1211111"} />
		<Helmet>
		<title>
				xMetals | Dapp
			</title>
		...
		>
			...
			<Box
				...
				align-items="center"
			>
				<Image src="https://uploads.quarkly.io/63e1507af2f031001fb80741/images/GoldKilo.jpg?v=2023-04-21T18:44:41.005Z" display="block" width="100%" border-radius="30px 30px 0px 00px" />
				<Box />
