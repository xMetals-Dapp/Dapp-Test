...
import xPD_Kilo from "components/xPD_kilo";
...
export default (() => {
	...
	try{
		...
		return <Theme theme={theme}>
			<GlobalQuarklyPageStyles pageUrl={"index12111"} />
			<Helmet>
			<title>
					xMetals | Dapp
				</title>
			...
			>
				...
				<Box
					...
					align-items="center"
				>
					<Image src="https://uploads.quarkly.io/63e1507af2f031001fb80741/images/Palladium_Kilo.jpg?v=2023-04-21T18:35:41.084Z" display="block" width="100%" border-radius="30px 30px 0px 00px" />
					<Box />
